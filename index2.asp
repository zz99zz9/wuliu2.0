...
<div class="Topmenu">
<ul>
<li class="l1" onClick="javascript:ChangeDiv('0','zhlb','zhbt',2)" id="zhbt0">近期关注</li>
<li class="l" onClick="javascript:ChangeDiv('1','zhlb','zhbt',2)" id="zhbt1">检索条件</li>
<li class="l" onClick="javascript:ChangeDiv('2','zhlb','zhbt',2)" id="zhbt2">展会列表</li>
</ul>
</div>
<div class="clear"></div>
<!--近期关注-->
<div id="zhlb0" class="zhlb"><br />

<!--#include virtual="inc/left_jqgz.asp"-->

</div>
<!--检索条件-->
<div id="zhlb1" class="zhlb"><br /><!--#include virtual="inc/left_sstj.asp"--></div>
<!--展会列表-->
<div id="zhlb2" class="zhlb"><br /><!--#include virtual="inc/left_zhlb.asp"--></div>
</div>
   ...
   　　 ←请在右边视窗选择一个展会的"<b>业务结算</b>"
    ...
    <%end if%>
          <div class="Topmenu">
        <ul>
          <li class="l1" onClick="javascript:ChangeDiv('0','zhlbr','zhb',4)" id="zhb0">收入费用</li>
          <li class="l" onClick="javascript:ChangeDiv('1','zhlbr','zhb',4)" id="zhb1">支出费用</li>
          <li class="l" onClick="javascript:ChangeDiv('2','zhlbr','zhb',4)" id="zhb2">费用清算</li>
          <li class="l" onClick="javascript:ChangeDiv('3','zhlbr','zhb',4)" id="zhb3">应收款报表</li>
...
<!--#include virtual="inc/Settlement.asp"-->
      </div>
      <!--应收款报表-->
